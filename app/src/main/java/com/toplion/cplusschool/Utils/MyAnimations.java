...
public class MyAnimations {
	...
	public static void startAnimationsIn(ViewGroup viewgroup, int durationMillis) {
		for (int i = 0; i < viewgroup.getChildCount(); i++) {
			LinearLayout inoutimagebutton = (LinearLayout) viewgroup
					.getChildAt(i);
			inoutimagebutton.setVisibility(View.VISIBLE);
			MarginLayoutParams mlp = (MarginLayoutParams) inoutimagebutton
					.getLayoutParams();
			Animation animation = new TranslateAnimation(200F, 0F, 1000F, 0F);
	...
	public static void startAnimationsOut(ViewGroup viewgroup,
										  int durationMillis, final RelativeLayout layout) {
		for (int i = 0; i < viewgroup.getChildCount(); i++) {
			final LinearLayout inoutimagebutton = (LinearLayout) viewgroup
					.getChildAt(i);
			MarginLayoutParams mlp = (MarginLayoutParams) inoutimagebutton
					.getLayoutParams();
			Animation animation = new TranslateAnimation(0F,200F
					, 0F, 1000F);
