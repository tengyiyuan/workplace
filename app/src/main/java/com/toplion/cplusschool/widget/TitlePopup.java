...
public class TitlePopup extends PopupWindow {
	...
	public TitlePopup(Context context, int width, int height){
		...
		setOutsideTouchable(true);
		//设置弹窗的布局界面
		popView=LayoutInflater.from(mContext).inflate(R.layout.title_popup,null);
...
//				int height = popView.findViewById(R.id.parent).getTop();
		...
		mListView.setAdapter(new BaseAdapter() {
			...
			public View getView(int position, View convertView, ViewGroup parent) {
				...
				if(convertView == null){
					...
					textView.setBackgroundResource(R.drawable.list_item_backnull);
				}else{
